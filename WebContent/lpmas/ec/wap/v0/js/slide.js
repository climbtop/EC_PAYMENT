...
$(function(){
    ...
    function dgo(n, comp) {
        ...
        onoff(idx, cur);
        cur = idx;
        //var b=$('#show').find('> div.img > span').children().length;
       // if(b!=2){
    ...
    $('<div class="btns"/ >')
        ...
        .append(pn_btn)
        .appendTo($root);
    $("#show .btns B I").eq(0).addClass('on');
    var c=$('#show').find('> div.img > span').children().length;
    if(c==2){
    ...
    var bb=$('#show').find('> div.img > span').children().length;
    if(bb!=2) {
