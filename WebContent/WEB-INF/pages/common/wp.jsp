...
<%@page import="com.trendy.ow.portal.payment.weixin.config.WeiXinJsApiConfig"%>
<%@page import="com.trendy.ow.portal.payment.business.PayUtil"%>
<%@page import="com.trendy.ow.portal.payment.weixin.bean.WeiXinJsApiConfigBean"%>
<%@page import="com.trendy.ow.portal.payment.cache.StoreInfoCache"%>
...
PayItemBean payItem=(PayItemBean)request.getAttribute("payItem");
WeiXinJsApiConfigBean configBean=(WeiXinJsApiConfigBean)request.getAttribute("configBean");

String body =  configBean.getBody();
//String body =  "测试";
String notify_url = basePath + WeiXinJsApiConfig.WX_NOTIFY_URL;
//String notify_url = "http://www.fiveplus.com";
String out_trade_no = payItem.getPayItemId()+"";
//String out_trade_no = "12342399";
//String callback_url = "http://www.fiveplus.com";
String callback_url = basePath + WeiXinJsApiConfig.WX_CALL_BACK_URL+"?itemId="+out_trade_no+"&err_msg=ok";
String total_fee = String.valueOf(((int)payInfo.getRequestAmount())*100);
//String total_fee = "300001";

String partner = configBean.getPartner();
String partnerKey = configBean.getPartnerKey();
String appKey = configBean.getAppKey();
...
<html>
    <head>
        ...
        <script Language="javascript">
            ...
            {
                return "<%=partnerKey%>";
                //return "23c880e2c5160afdcb7401407209466f";
            }
            ...
            {
                return "<%=appId%>";
                //return "wxbcdf0d58922caa13";
            }
            
            function getAppKey()
            {
                return "<%=appKey%>";
                //return "Y1YPRbqLvVXNYE8FiFquyexdnZ1VOHm2vc7IPsGmQZbXZcFbXQcCwxb1eyCQND2sz6UQm3H4mED8PKYlNpqKOVzBzDTWmc1x8DWj3DAsGW807BhRxxnM9raTc9HKSvnK";
            }
    ...
    <body>
        ...
        <div class="WCPay" style="display:none;">
